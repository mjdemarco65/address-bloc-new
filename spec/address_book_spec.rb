...
RSpec.describe AddressBook do
    let(:book) {AddressBook.new}
     ...
     describe "detonate" do
       it "deletes all entries in the book" do
         book.add_entry("Michael DeMarco", "111-222-3333","michael@gmail.com")
         book.add_entry("John Parker", "222-333-4444","john@gmail.com")
         book.add_entry("Sam Hastings", "333-444-5555","sam@gmail.com")
   ...
   it "searches AddressBook for Billy" do
    ...
    describe "#import_from_csv" do
     ...
     it "imports the 1st entry" do
       ...
       check_entry(entry_one, "Michael", "970-470-1111", "michael@gmail.com")
       #expect(entry_one.name).to eql "Michael"
       #expect(entry_one.phone_number).to eql "970-470-1111"
       #expect(entry_one.email).to eql "michael@gmail.com"
     end
     ...
     it "imports the 2nd entry" do
       ...
       check_entry(entry_two, "Michael", "970-470-1111", "michael@gmail.com")
       #expect(entry_two.name).to eql "Michael"
       #expect(entry_two.phone_number).to eql "970-470-1111"
       #expect(entry_two.email).to eql "michael@gmail.com"
     end
     ...
     it "imports the 3rd entry" do
       ...
       check_entry(entry_three, "Michael", "970-470-1111", "michael@gmail.com")
       #expect(entry_three.name).to eql "Michael"
       #expect(entry_three.phone_number).to eql "970-470-1111"
       #expect(entry_three.email).to eql "michael@gmail.com"
     end
   end
