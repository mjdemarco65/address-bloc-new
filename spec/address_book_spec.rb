...
RSpec.describe AddressBook do
    ...
    describe "#import_from_csv" do
     ...
     it "imports the 1st entry" do
       ...
       check_entry(entry_one, "Alana", "970-470-1111", "alana@gmail.com")
       #expect(entry_one.name).to eql "Alana"
       #expect(entry_one.phone_number).to eql "970-470-1111"
       #expect(entry_one.email).to eql "alana@gmail.com"
     end
     ...
     it "imports the 2nd entry" do
       ...
       check_entry(entry_two, "Boris", "970-470-1111", "boris@gmail.com")
       #expect(entry_two.name).to eql "Boris"
       #expect(entry_two.phone_number).to eql "970-470-1111"
       #expect(entry_two.email).to eql "boris@gmail.com"
     end
     ...
     it "imports the 3rd entry" do
       ...
       check_entry(entry_three, "Chris", "970-470-1111", "chris@gmail.com")
       #expect(entry_three.name).to eql "Chris"
       #expect(entry_three.phone_number).to eql "970-470-1111"
       #expect(entry_three.email).to eql "chris@gmail.com"
     end
   end
